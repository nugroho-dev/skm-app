            ...
            case 'admin_instansi':
                return [
                        ...
                        [
                            'label' => 'Pengaturan',
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1"> 
                            <path d="M12 9v3l2 2m-4 0l2 -2m-2 -3h6a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-6a2 2 0 0 1 -2 -2v-6a2 2 0 0 1 2 -2z" /> 
                            <path d="M12.5 12.5l-1.5 -1.5m3 -3l-1.5 -1.5m-3 -3l-1.5 -1.5m6 -6l-1.5 -1.5m3.5 3.5l-1.5 -1.5m-3 -3l-1.5 -1.5m6 -6l-1.5 -1.5m3.5 3.5l-1.5 -1.5" />
                            </svg>',
                            'url' => route('dashboard')
                        ],
                ];
