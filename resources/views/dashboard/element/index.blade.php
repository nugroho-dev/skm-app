            ...
            <div class="row g-2 align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="d-flex">
                  ...
                  <a href="{{ route('unsur.create') }}" class="btn btn-primary btn-3 m-1">
            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Data Unsur</h3>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-selectable card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                          ...
                          <td class="text-end">
                            <span class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ route('unsur.edit', $element->id)  }}"> Edit </a>
                                <form action="{{ route('unsur.destroy', $element->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                  @csrf
                                  @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="border px-4 py-2 text-center text-gray-500">Tidak ada data unsur di instansi ini.</td>
                        </tr>
                        @endforelse
                      </tbody>
                    </table>
