              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="d-flex btn-list">
                 ...
                 <button onclick="printTable('tabel-ikm')" class="btn btn-dark ">
                  ...
                  <a href="{{ auth()->user()->hasRole('super_admin') ? route('ikm.service.cetak.publikasi.pdf', request()->all()) : route('instansi.ikm.service.cetak.publikasi.pdf', request()->all())}}" target="_blank" class="btn btn-danger">
                  ...
                  <a href="{{ auth()->user()->hasRole('super_admin') ?  route('ikm.service.cetak.pdf', request()->all()) :  route('instansi.ikm.service.cetak.pdf', request()->all())}}" target="_blank" class="btn btn-danger">
