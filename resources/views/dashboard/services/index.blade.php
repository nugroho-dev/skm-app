          ...
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="d-flex">
                  <a href="{{ auth()->user()->hasRole('super_admin') ? route('institutions.index') : route('instansi.dashboard') }}" class="btn btn-secondary m-1">Kembali</a>
                  <a href="{{ auth()->user()->hasRole('super_admin') ? route('service.create', ['institution' => $institution_id]) : route('instansi.services.create') }}" class="btn btn-primary btn-3 m-1">
                    ...
                    <div class="d-flex">
                      ...
                      <div class="ms-auto text-secondary">
                        ...
                        <div class="ms-2 d-inline-block">
                           <form method="GET" action="{{ auth()->user()->hasRole('super_admin') ? route('service.index') : route('instansi.services.index') }}" class="d-flex">
                            <input type="hidden" name="institution" value="{{ auth()->user()->hasRole('super_admin') ? request('institution', $institution_id) : $institution_id }}">
                          ...
                          <td class="text-end">
                            <span class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ auth()->user()->hasRole('super_admin') ? route('service.edit', $service->id) : route('instansi.services.edit', $service->id) }}"> Edit </a>
                                <form action="{{ auth()->user()->hasRole('super_admin') ? route('service.destroy', $service->id) : route('instansi.services.destroy', $service->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus layanan instansi ini?')">
                                  @csrf
                                  @method('DELETE')
