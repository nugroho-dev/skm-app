            ...
            <div class="row g-2 align-items-center">
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="d-flex">
                  ...
                  <a href="{{ route('pekerjaan.create') }}" class="btn btn-primary btn-3 m-1">
                    ...
                    <table class="table table-selectable card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><span class="text-secondary">{{ $occupations->firstItem() + $index }}</span></td>
                          <td><a href="invoice.html" class="text-reset" tabindex="-1">{{ $occupation->type }}</a></td>
                          <td class="text-end">
                            <span class="dropdown">
                              <button class="btn dropdown-toggle align-text-top" data-bs-boundary="viewport" data-bs-toggle="dropdown">Actions</button>
                              <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ route('pekerjaan.edit', $occupation->id)  }}"> Edit </a>
                                <form action="{{ route('pekerjaan.destroy', $occupation->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus layanan instansi ini?')">
                                  @csrf
                                  @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="border px-4 py-2 text-center text-gray-500">Tidak ada data pekerjaan di instansi ini.</td>
                        </tr>
                        @endforelse
                      </tbody>
                    </table>
